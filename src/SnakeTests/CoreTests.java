...
public class CoreTests extends Assert {
    ...
    public void test4Growing() throws Exception {
        ...
        IObject[] f = new FoodFactory().configure(game, new Point[] {new Point(0, 1)});
        game.setObjs(f);
    ...
    public void test5D1Teleport() throws Exception {
        ...
        IObject[] t = (new TeleportFactory()).configure(game,
    ...
    public void test6Hedg() throws Exception {
        for (int i = 0; i < 10; i++) {
            ...
            IObject[] t = (new HedgFactory()).configure(game,
                    new Point[] {new Point(0, 1), new Point(1, 0)});
            game.setObjs(t);
    ...
    public void test7Pillow() throws Exception {
        ...
        IObject[] t = (new PillowFactory()).configure(game, new Point[] {new Point(0, 1)});
        game.setObjs(t);
        game.makeTick();
        if (!(game.makeTick() && game.getMap()[0][0] == '@')) {
            throw new Exception();
